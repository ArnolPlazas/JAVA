...
public class Marco_Dialogos extends JFrame {
    public Marco_Dialogos(){
        ...
        lamina_tipo_opcion=new Lamina_Botones("Mensaje",new String[]{
           "DEFAULT_OPTION",
            "YES_NO_OPTION",
            "YES_NO_CANCEL_OPTION",
            "OK_CANCEL_OPTION"
        });
        lamina_opciones=new Lamina_Botones("Mensaje",new String[]{
           "String[]",
            "Icon[]",
            "Object[]"
        });
        lamina_entrada=new Lamina_Botones("Mensaje",new String[]{
           "Campo de texto",
            "Combo"
        }); 
    ...
    //-----------------------------------------------------------------------------------------
    //-----------------------------------Develve tipo de icono y botones-------------------------
    ...
    //-----------------------------------------------------------------------------------------
    //---------------------------------Opciones de Lamina opciones-------------------------------
    public Object[] dameOpciones(Lamina_Botones lamina){
        String s=lamina.dameSeleccion();
        if(s.equals("String[]")){
            return new String[]{"Amarillo","Azul","Rojo"};
        }else if(s.equals("Icon[]")){
            return new Object[]{new ImageIcon("build/classes/graficos/icons8-playAm-16.png"),new ImageIcon("build/classes/graficos/icons8-playAz-16.png"),new ImageIcon("build/classes/graficos/icons8-playRo-16.png")};
        }else if(s.equals("Object[]")){
            return new Object[]{cadenaMensaje,
                    iconoMensaje,
                    componenteMensaje,
    ...
    private Icon iconoMensaje=new ImageIcon("build/classes/Practicas/icons8-colombia-26.png");
